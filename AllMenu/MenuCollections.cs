...
namespace HospitalProject.AllMenu
{
    public class MenuCollections
    {
        ...
        public static AdminLogin adminLog = new AdminLogin();       
        public static AdminPermissions adminPermission = new AdminPermissions();
        ...
        public static AdminRegistration adminReg = new AdminRegistration();
        ...
        public static string[] adminLoginPage = { "Admin Registration", "Admin Login", "Back" };
        ...
        public static string[] mainPage = { "Admin Section", "User Section", "Doctor Section", "Exit" };
        public static string[] adminPage = { "Delete User", "Delete Doctor", "Back" };
        ...
        public static string[] DoctorOwnPage = { "My Appointment", "Back" };
