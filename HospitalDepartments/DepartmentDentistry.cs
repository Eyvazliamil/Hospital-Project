...
{
    public class DepartmentDentistry
    { 
        static public bool DentistryMethod(string file)
        {
            try
            {
                if (!File.Exists(file))
                    throw new EmptyException("No doctors work at dentistry department yet!");

                string[] linesDentistryDoctor = File.ReadAllLines(file);
                short ldp = MenuHelper.ShowMenu(linesDentistryDoctor, "======== Dentistry Doctors ========");
                return true;
            }
        ...
        static public void getInfoDentistryDoctor(string file)
        { 
            ...
            try
            {
                ...
                short ldp = MenuHelper.ShowMenu(onlyDoctorNames, "======== Dentistry Doctors ========");
                Console.Clear(); 
